...
# %%
# ls -trl ~/+Simulations/ChannelFlow

# %%
checkpoint_dir = "../Examples-StokesFlow/output/ChannelFlow3D"
checkpoint_dir = "/Users/lmoresi/+Simulations/ChannelFlow"
checkpoint_base = f"WigglyBottom_25"
meshfile = os.path.join(checkpoint_dir, checkpoint_base) + ".mesh.00000.h5"

step = 0

# %%
uw.utilities.h5_scan(f"{checkpoint_dir}/WigglyBottom_25.mesh.P1.00000.h5")
