...
p_soln = uw.discretisation.MeshVariable(['P','h'],meshball, num_components=2, continuous=True,
                                          degree=1, vtype=uw.VarType.COMPOSITE )
...
stokes_f = Stokes(meshball, velocityField=v_soln, pressureField=p_soln, 
                  solver_name="stokes_fixed")
