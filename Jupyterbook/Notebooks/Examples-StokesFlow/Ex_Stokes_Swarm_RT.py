...
if uw.mpi.size == 1 and render:
    ...
    pl.add_arrows(arrow_loc, arrow_length, mag=25, opacity=0.5)
...
def plot_mesh(filename):
    ...
    if uw.mpi.size == 1:
        ...
        vmag = np.hypot(arrow_length[:,0:2]).max()
        ...
        pl.add_arrows(arrow_loc, arrow_length, mag=100/vmag, opacity=0.5)
