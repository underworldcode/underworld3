...
# +
mesh = uw.meshing.StructuredQuadBox( minCoords=(0.0,0.0), 
                                          maxCoords=(1.0,1.0), 
                                          elementRes=(32,32) )
...
# +
mesh = uw.meshing.StructuredQuadBox( minCoords=(0.0,0.0,0.0), 
...
# +
mesh = uw.meshing.UnstructuredSimplexBox( minCoords=(0.0,0.0,0.0), 
                                               maxCoords=(1.0,1.0,1.0), 
                                               cellSize=1.0/8.0, 
                                               regular=True)
