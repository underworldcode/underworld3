"""Render the existing baseline checkpoints (from
exp-integrator-freesurface worktree, scheme=rk4 + monotone clamp,
35 steps) using the proper P3 sub-cell triangulation pipeline.
Matches the layout of the original three-way-compare image's
"preferred" row.
"""
