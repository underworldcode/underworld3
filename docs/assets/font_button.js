...
if (savedStyle == "legible") legibleFontSetter("legible");
else legibleFontSetter("pretty");
...
function legibleFontSetter(fontType) {
  if (fontType == "legible") {
    legibleFontFamily = getComputedStyle(
      document.documentElement,
    ).getPropertyValue("--pst-font-family-legible");
    legibleFontFamilyH = getComputedStyle(
      document.documentElement,
    ).getPropertyValue("--pst-font-family-legible-headers");
    document.documentElement.style.setProperty(
    ...
    prettyFontFamily = getComputedStyle(
      document.documentElement,
    ).getPropertyValue("--pst-font-family-pretty");
    prettyFontFamilyH = getComputedStyle(
      document.documentElement,
    ).getPropertyValue("--pst-font-family-pretty-headers");
    document.documentElement.style.setProperty(
      "--pst-font-family-base",
      prettyFontFamily,
    );
