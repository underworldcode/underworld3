# %% [markdown]
"""
# 🎓 Navier Stokes Benchmarks NS DFG 2d
...
#         St.sym_1d[0], swarm._particle_coordinates.data
#     )
#     stress_star_p.data[:, 1] = uw.function.evaluate(
#         St.sym_1d[1], swarm._particle_coordinates.data
#     )
#     stress_star_p.data[:, 2] = uw.function.evaluate(
#         St.sym_1d[2], swarm._particle_coordinates.data
#     )
