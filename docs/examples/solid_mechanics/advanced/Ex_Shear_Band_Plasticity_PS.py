...
v_soln.array[...] = uw.function.evaluate(sympy.Matrix(((vx_ps, vy_ps))), v_soln.coords)
...
# nodal_strain_rate_inv2.add_dirichlet_bc((+1.0, None), "top")
# nodal_strain_rate_inv2.add_dirichlet_bc((-1.0, None), "bottom")
...
nodal_visc_calc = uw.systems.Projection(
    mesh1,
    node_viscosity)
