...
In addition to the notebooks in this brief set of examples, there are a number of sources of information on using `Underworld3` that you can access:
  ...
  (all the modules and functions and their full sets of arguments) is automatically generated from the source code and uses the same rich markdown content as the notebook help text. There is also a set of [API docs](https://underworldcode.github.io/underworld3/main_api/underworld3/index.html) for the development branch.
