...
```{=html}
<center>
<iframe src="media/pyvista/SphereStreamLines.html" width="500" height="300"></iframe>
</center>
```
---

Welcome to `Underworld3`, a mathematically self-describing, finite-element code for geodynamic modelling. This quick-start guide is a brief introduction to some of the concepts in the
`Underworld3` code and it's a good first step after you install the code to look at these notebooks. When you are happy that things are working OK, you can move along to look at the full documentation. - LINK NEEDED -
...
To add: something with a swarm - perhaps Navier Stokes, Poisseuille flow, non-steady input velocity (?)
