...
It's a good first step after you install the code to look at these notebooks. When you are happy that things are working OK, you can move along to look at the full documentation or the benchmarking repository.
...
Notebook 7 - Unsteady flow   Using a passive swarm to track the pattern of flow developing in a pipe after an impulsive application of a boundary condition at the inflow. Particles need to be added to the passive swarm close to the inflow at each timestep.

Notebook 8 - Swarm variables - exploring how they work for specifying material properties with a swarm used to determine element viscosity. We learn how to use swarm variables in expressions generally and for boundary conditions.
