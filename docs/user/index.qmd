...
The quickest option is **not to install** anything but click on the rocket icon (top right) to launch our notebook examples on binder.

If do you want to install the code on your own machine, we recommend using `miniconda` and `mamba` and to create a separate virtual environment and to install the code from source.
