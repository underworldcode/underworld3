...
- Works closely with [Mathematical Objects](../UW3_Developers_MathematicalObjects.qmd)
- Integrates with [JIT Compilation](jit-compilation.qmd)
- Used by [Solvers](solvers.qmd) for symbolic equation definition
