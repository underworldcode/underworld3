...
- Critical for [Performance Optimization](../guidelines/performance-optimization.qmd)
- Integrates with [PETSc Integration](../advanced/petsc-integration.qmd)
- Used by [Solvers](solvers.qmd) for computational kernels
