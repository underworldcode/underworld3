...
def test_SLVec_boxmesh(mesh):
    ...
    if uw.is_notebook:
        ...
        scatter1 = ax1.scatter(
            coords_init[:, 0], coords_init[:, 1], c=vec_mag_init, s=20, cmap="viridis", alpha=0.8
        )
        ax1.set_xlabel("x")
        ax1.set_ylabel("y")
        ...
        scatter2 = ax2.scatter(
            coords_init[:, 0], coords_init[:, 1], c=vec_mag, s=20, cmap="viridis", alpha=0.8
        )
        ax2.set_xlabel("x")
        ax2.set_ylabel("y")
        ...
        ax3.axvline(
            ...
            linestyle="--",
            alpha=0.5,
            label=f"Expected peak (y={y_peak_loc:.3f})",
        )
