...
STATUS (2025-12-01):
- All 5 tests PASSING ✅
- Fixed: _handle_under_determined_system() now properly solves sub-system for
  covered dimensions (L, M, T) when temperature is not needed.
- Isothermal Stokes problems work correctly without requiring temperature scale.
"""
