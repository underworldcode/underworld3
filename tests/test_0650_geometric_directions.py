...
class TestGeometricDirections:
    ...
    def test_cartesian_2d_geometric_properties(self):
        ...
        expected_keys = {'unit_e_0', 'unit_e_1', 'unit_horizontal', 'unit_horizontal_0', 
                        'unit_horizontal_1', 'unit_vertical'}
    ...
    def test_cylindrical_2d_geometric_properties(self):
        ...
        directions = cs.primary_directions
        expected_keys = {'unit_e_0', 'unit_e_1', 'unit_horizontal', 'unit_horizontal_0', 
                        'unit_horizontal_1', 'unit_vertical', 'unit_radial', 'unit_tangential'}
        assert set(directions.keys()) == expected_keys
    ...
    def test_spherical_geometric_properties(self):
        ...
        # Test primary_directions dictionary
        directions = cs.primary_directions
        expected_keys = {'unit_e_0', 'unit_e_1', 'unit_e_2', 'unit_horizontal', 'unit_horizontal_0', 
                        'unit_horizontal_1', 'unit_vertical', 'unit_radial', 'unit_meridional', 'unit_azimuthal'}
        assert set(directions.keys()) == expected_keys
    ...
    def test_unit_vector_normalization(self):
        ...
        for px, py in test_points:
            ...
            assert abs(tangential_norm - 1.0) < 1e-10, f"Tangential vector not normalized at ({px}, {py})"
    ...
    def test_primary_directions_completeness(self):
        ...
        expected_2d = {'unit_e_0', 'unit_e_1', 'unit_horizontal', 'unit_horizontal_0', 
                      'unit_horizontal_1', 'unit_vertical'}
        ...
        expected_sph = {'unit_e_0', 'unit_e_1', 'unit_e_2', 'unit_horizontal', 'unit_horizontal_0', 
                       'unit_horizontal_1', 'unit_vertical', 'unit_radial', 'unit_meridional', 'unit_azimuthal'}
    ...
    def test_cartesian_profile_sampling(self):
        ...
        assert np.allclose(horizontal_sample['cartesian_coords'], horizontal_sample['natural_coords'])
    ...
    def test_line_sampling_consistency(self):
        ...
        line_sample = cs.create_line_sample(
            start_point=[0.2, 0.3],
            direction_vector=cs.unit_horizontal,
            length=0.6,
            num_points=4
        )
