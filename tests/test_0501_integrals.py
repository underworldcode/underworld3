...
def test_integrate_swarmvar_deriv_O1():
    ...
    # Direct access using public API
    s_values.data[:, 0] = np.cos(np.pi * swarm.points[:, 1])
...
def test_integrate_swarmvar_O3():
    ...
    # Direct access using public API
    s_values_3.data[:, 0] = np.cos(np.pi * swarm.points[:, 0])
...
def test_integrate_swarmvar_deriv_03():
    ...
    # Direct access using public API
    s_values_3.data[:, 0] = np.cos(np.pi * swarm.points[:, 1])
...
def test_integrate_swarmvar_O0():
    ...
    # Direct access using public API
    s_values_0.data[:, 0] = np.cos(np.pi * swarm.points[:, 0])
...
def test_integrate_swarmvar_deriv_00():
    ...
    # Direct access using public API
    s_values_0.data[:, 0] = np.sin(np.pi * swarm.points[:, 1])
